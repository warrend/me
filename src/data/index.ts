...
export const portfolioData = {
  name: "Daniel Warren",
  intro:
    "Reading a coding resume is boring so I added my artwork to liven up the place. Minimize this window to see better. It’s also draggable around the screen. Then when you’re done, you can come back here and look at my credentials.",
  about:
